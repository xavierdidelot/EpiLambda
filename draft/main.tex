...
We now define our own lambda-coalescent based on the Negative-Binomial case describe previously.
The ease of comparison with other coalescent models, we consider that time is continuous,
and that the population size remains fixed at $N_t$. 
...
Our lambda-coalescent could be defined in a varying population size and/or with
temporally offset leaves following the same approach as previously described for
the beta-coalescent \citep{Hoscheit2019}.
