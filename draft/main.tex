...
[[Do we need to mention simultaneous multiple mergers decaying fast as well or at least mention that they have been neglected? -DH]]
...
[[Is it worth mentioning any potential relationship to variance-effective population size of the sorts one gets in cannings type models and similar? This might explain the poor identifiability - DH]]
...
do not co-occur. [[Would it be worth doing an exact simulation and comparing how much of an error there is? In the exact coalescent for WF the most common mergers other than binary are simultaneous binary mergers and 3-mergers. This would presumably lead to an overestimate of the coalescent rate and an underestimate of the variance if neglected.]]

[[UNSURE ABOUT PLACEMENT AND PHRASING -DH]]
There is a clear relationship between this work and the work of \citep{fu_exact_2006} on the exact coalescent for the Wright-Fisher process. The exact coalescent for the Wright-Fisher corresponds to exact, discrete times genealogies of a finite-size Wright-Fisher process. Unlike this work, multiple simultaneous mergers aren't neglected, population size is assumed to be constant in all rate calculations, and the offspring distribution has a variance of $1$ for all individuals.
