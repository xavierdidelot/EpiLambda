...
to the offspring distribution. Here we consider the reverse problem of the transmission ancestry, going backward-in-time, from a sample of infected individuals. 
...
Modelling within-host evolution to bridge the gap \citep{Didelot2014,Didelot2017}.
