...
Figure \ref{fig:tree} shows examples of trees simulated for a sample of size $n=20$ and
with constant population size $N_t=40$. As the dispersion parameter increases from $r=0.1$
to $r=10$ multimerger events become less and less likely and large, and the
