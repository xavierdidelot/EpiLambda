...
Show that exclusive probabilities $p_{n,k,t}$ for $k>2$ is small compared to $p_{n,2,t}$.

Show that inclusive and exclusive probabilities become equal.
...
\begin{equation}
p_{2,t}=p_{n,2,t}=\frac{r+1}{N_t r +1}
\end{equation}
...
\citep{Fraser2017} has:
 \begin{equation}
 p_{2,t}=\frac{V_t+R_t^2-R_t}{N_t R_t -R_t}
 \end{equation}

For Poisson case we have $V_t=R_t$ so this reduces to $R_t/N_t$.

For NegBin case we have:

\begin{equation}
p_{2,t}=\frac{V_t+R_t^2-R_t}{N_t R_t -R_t}=\frac{1/p+R-1}{N-1}=\frac{r+R+Rr-r}{Nr-r}
=\frac{Rr+R}{Nr-r}
\end{equation}
