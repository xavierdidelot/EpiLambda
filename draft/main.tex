...
\begin{document}
{\Large Coalescent process for infectious disease outbreaks with superspreading}
...
\vspace*{2cm}
Running title: Coalescent for outbreaks with superspreading
...
In this study we consider the transmission tree 
